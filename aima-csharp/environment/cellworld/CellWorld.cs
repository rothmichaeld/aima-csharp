...
namespace aima.core.environment.cellworld
{
    ...
    {
        private readonly LinkedHashSet<Cell<C>> cells = new LinkedHashSet<Cell<C>>();
        private readonly Dictionary<int, Dictionary<int, Cell<C>>> cellLookup = new Dictionary<int, Dictionary<int, Cell<C>>>();
        /**
