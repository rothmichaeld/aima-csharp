...
namespace aima.core.logic.fol
{
    ...
    {
        private static readonly Dictionary<char, int> _assignedIndexicals = new Dictionary<char, int>();
    ...
    internal class StandardizeApartIndexicalImpl : StandardizeApartIndexical
    {
