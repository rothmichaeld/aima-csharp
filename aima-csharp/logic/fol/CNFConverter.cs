...
namespace aima.core.logic.fol
{
    ...
    {
        private readonly FOLParser parser = null;
    ...
    internal class ImplicationsOut : FOLVisitor
    {
    ...
    internal class NegationsIn : FOLVisitor
    {
        public NegationsIn()
        {
    ...
    internal class StandardizeQuantiferVariables : FOLVisitor
    {
        // Just use a localized indexical here.
        private readonly ApartIndexical quantifiedIndexical = new ApartIndexical();
        ...
        private readonly SubstVisitor substVisitor = null;
    ...
    internal class RemoveQuantifiers : FOLVisitor
    {
    ...
    internal class DistributeOrOverAnd : FOLVisitor
    {
    ...
    internal class CNFConstructor : FOLVisitor
    {
