...
namespace aima.core.logic.fol.inference
{
    ...
    public class FOLModelElimination : InferenceProcedure
    {
        ...
        private readonly FOLModelEliminationTracer tracer = null;
        private readonly Unifier unifier = new Unifier();
        private readonly SubstVisitor substVisitor = new SubstVisitor();
        ...
        private class AnswerHandler : InferenceResult
        {
            private readonly Chain answerChain = new Chain();
            private readonly List<Variable> answerLiteralVariables;
            private readonly List<Chain> sos = null;
    ...
    internal class IndexedFarParents
    {
        private int saIdx = 0;
        private readonly Unifier unifier = new Unifier();
        private readonly SubstVisitor substVisitor = new SubstVisitor();
        private readonly Dictionary<String, List<Chain>> posHeads = new Dictionary<String, List<Chain>>();
        private readonly Dictionary<String, List<Chain>> negHeads = new Dictionary<String, List<Chain>>();
