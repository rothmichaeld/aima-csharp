 ...
 */
    public class FOLOTTERLikeTheoremProver : InferenceProcedure
    {
        ...
        private readonly Paramodulation paramodulation = new Paramodulation();
        ...
        private class IndexedClauses
        {
            private readonly LightestClauseHeuristic lightestClauseHeuristic = null;
            // Group the clauses by their # of literals.
            private readonly Dictionary<int, List<Clause>> clausesGroupedBySize = new Dictionary<int, List<Clause>>();
        ...
        private class OTTERAnswerHandler : InferenceResult
        {
