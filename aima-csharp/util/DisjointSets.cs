...
namespace aima.core.util
{
    ...
    {
        private readonly Dictionary<E, HashSet<E>> elementToSet = new Dictionary<E, HashSet<E>>();
        private readonly LinkedHashSet<HashSet<E>> disjointSets = new LinkedHashSet<HashSet<E>>();
